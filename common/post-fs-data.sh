...
sed 's;^ro.*\.build\.fingerprint=.*;ro.build.fingerprint=motorola/ali/ali:9/PPS29.55-37-4/908b8:user/release-keys;' /system/build.prop > /data/local/tmp/build.prop
...
resetprop ro.build.fingerprint 'motorola/ali/ali:9/PPS29.55-37-4/908b8:user/release-keys'
resetprop ro.bootimage.build.fingerprint 'motorola/ali/ali_retail:9/PPS29.55-37-4/908b8:user/release-keys'
